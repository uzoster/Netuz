...
export default function Header_yangiik_barder() {
  return (
        ...
        <div className="topInfo_Home">
                      ...
                      <div data-aos="zoom-in-down" className="rightInfo_home">
                        <ul>
                          ...
                          <li><Link data-aos="zoom-in-down" to="/yangilk">Yangiliklar</Link></li>
                        </ul>
        ...
        <nav className="navigation__nav" role="navigation">
          ...
          <div className="button_info_allPros">
                <div data-aos="zoom-in-down" className="rightInnfo_allPrt">
                  <h1 data-aos="zoom-in-down" >BIZ <b>HAQIMIZDAGI</b>  KUNLIK YANGILIKLAR </h1>
                </div>
                <div className="left_info_kurslar" data-aos="zoom-in-down">
                     <img data-aos="zoom-in-down" src="https://cdn3d.iconscout.com/3d/premium/thumb/news-2872704-2409420.png?f=webp" alt="" />
                </div>
          </div>
